...
<body>
 <!--  <div id="header">
    <h1>Credos data visualzation</h1>
    <label>진단 횟수</label>
    <div id="container">
  ...
  <script type="text/javascript" src="resources/script/rotate.js"></script>
  <script type="text/javascript" src="resources/script/home2.js"></script>
</body>
</html>